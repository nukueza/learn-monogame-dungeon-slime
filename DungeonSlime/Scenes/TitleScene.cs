...
public class TitleScene : Scene
{
  ...
  public override void Initialize()
  {
    ...
    // setting up background pattern destination
  ...
  public override void LoadContent()
  {
    ...
    // Load texture atlas from the xml
  ...
  public override void Update(GameTime gameTime)
  {
    ...
    // Ensure that the offset do not go beyound the texture bounds
  ...
  public override void Draw(GameTime gameTime)
  {
    ...
    // Draw the background pattern first using the pointWrap
    Core.SpriteBatch.Begin(samplerState: SamplerState.PointWrap);
    Core.SpriteBatch.Draw(_backgroundPattern, _backgroundDestination, new Rectangle(_backgroundOffset.ToPoint(), _backgroundDestination.Size), color: Color.White);
    ...
    // draw the dungeon text slightly offset from it is original pos
    // and with transparent color to give it  a drop shadow
